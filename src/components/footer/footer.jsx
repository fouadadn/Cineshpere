                    ...
                    <div className="flex justify-center relative  ">
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-center gap-5">
                                <input className='outline-none text-white text-sm bg-[#7300FF10] border-[#a473ff] border-[1px] px-6 py-3 rounded-xl lg:w-96' type="email" placeholder='Email Address' />
